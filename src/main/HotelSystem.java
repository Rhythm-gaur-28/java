...
public class HotelSystem {
    ...
    private static void addGuest(Scanner scanner) {
        ...
        FileManager.saveGuestsToFile(guestList, "guests.txt");
    ...
    private static void addRoom(Scanner scanner) {
        ...
        FileManager.saveRoomsToFile(roomList, "rooms.txt");
    ...
    private static void addBooking(Scanner scanner) {
        ...
        if (guest != null && room != null) {
            ...
            FileManager.saveBookingsToFile(bookingList, "bookings.txt");
    ...
    private static void sortBookings() {
        BookingSort.sortBookingsByCheckInDate(bookingList);
        FileManager.saveBookingsToFile(bookingList, "sortbookings.txt");
        System.out.println("Bookings sorted by check-in date.");
    ...
    private static void addServiceRequest(Scanner scanner) {
        ...
        if (room != null) {
            ...
            ServiceLinkedList serviceRequests = ServiceLinkedList;
